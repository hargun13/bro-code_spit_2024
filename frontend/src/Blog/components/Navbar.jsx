  ...
  return (
    <div className=" bg-white flex justify-between px-10 h-20  items-center py-11 border-b-[1px] border-gray-300 fixed w-screen md:z-0 z-50">
      ...
      <ul className="hidden md:flex">
        ...
        <li className="p-4 mx-5 text-lg  cursor-pointer bg-[#090909] text-white flex items-center justify-center">
          <CiSearch size={25} />
        </li>
      </ul>
      ...
      >
        <p className="p-1 px-3 py-5 text-3xl border-b-[1px] border-gray-300">
          The Blog
        </p>
