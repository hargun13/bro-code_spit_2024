...
const CRChatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      img: img,
      side: 'left',
      text: `Hey! Seems you are intrigued about ${"title"}. Don't worry, chat with me to get all your doubts cleared`,
  ...
  return (
    <div>
        <h1 className='text-3xl py-3 px-2'>Learn More About - {}</h1>
        <div className="msger">
